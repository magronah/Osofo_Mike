...
ggsave(paste0("Results_Findings/","transfer_proportion.png"), 
       plot = plot1, width = plot_width, height = plot_height, dpi = 300)
####### Ploting frequency for each transfer
plot2  =  ggplot(dd, aes(Transfer,Frequency, group = 1)) + 
  geom_point() +
  geom_line() + 
  custom_theme(plot_size) +
...
ggsave(paste0("Results_Findings/","transfer_count.png"), 
       plot = plot2, width = plot_width, height = plot_height, dpi = 300)
#########################
